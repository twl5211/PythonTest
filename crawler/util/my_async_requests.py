# -*- coding: utf-8 -*-
# @Time ： 2024/6/28 22:32
# @Auth ： HongBao
# @File ：my_async_requests.py
# @IDE ：PyCharm
import asyncio
import random
import time
    ...
    async with semaphore:
        async with httpx.AsyncClient() as client:
            ...
            if res.status_code == 200:
                ...
                html = html.xpath('//*[@id="main_left"]/div[1]//text()')
                return html
            # await asyncio.sleep(1)  # 延时 2 秒
        pass


async def main():
    urlList = [
        'https://www.shicimingju.com/book/sanguoyanyi/{}.html'.format(i) for i in range(1, 120)
    ]

    tasks = [
        asyncio.create_task(func_a(url)) for url in urlList
    ]
